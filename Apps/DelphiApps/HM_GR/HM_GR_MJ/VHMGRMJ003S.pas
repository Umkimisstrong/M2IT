...
uses
  ...
  Dialogs, Grids, BaseGrid, AdvGrid, TFlatCheckBoxUnit, TFlatSpinEditUnit,
  StdCtrls, TFlatEditUnit, TFlatComboBoxUnit, TFlatButtonUnit,
  TFlatLabelUnit, ExtCtrls, TFlatPanelUnit, TFlatTabControlUnit;
